...
/**
 * 监控商投Nginx 接收数据 , oemid 粒度
 * @author shaoyl
 *
 */
public  class MonNginxCreativeAndOemid extends AbastractBaseFileJob {
...
//		long start  = System.currentTimeMillis();
		...
		for(Map<String,Object> creativeInfoMap:creativeInfoList){
            ...
            String oemid = "";
            String oemname = "";
            if(null!=creativeInfoMap.get("oemid") && null!=creativeInfoMap.get("oemname")){
                byOem = true;
                oemid = creativeInfoMap.get("oemid").toString();
                oemname = creativeInfoMap.get("oemname").toString();
            }

            logger.info("开始统计信息： byOem=[" + byOem+"], creativeId=["+creativeId+"], creativeName=["+creativeName+"], " +
                    "oemid=["+oemid+"], oemname=["+oemname+"]");
            ...
            if(byOem){
                ...
                //统计当天总量
                backFile = monitorPath + time +"/a/*.o|grep 'd=" + creativeId + "'|grep 'c="+oemid+"'";
                ...
                //统计小时
                String hourPath = monitorPath + time +"/a/*.o|grep 'starttime="+hourTime+"'|grep 'd=" + creativeId + "'|grep 'c="+oemid+"'";
                ...
                line = timeMin + ", " + creativeId + ", " + creativeName + ", " + oemid + ", " + oemname + ", " + result + ", " + hourResult + "\n";
                ...
                //统计小时
                String hourPath = monitorPath + time +"/a/*.o|grep 'starttime="+hourTime+"'|grep 'd=" + creativeId + "'";
                ...
                line = timeMin + ", " + creativeId + ", " + creativeName + ", " + result + ", " + hourResult + "\n";
